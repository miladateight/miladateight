export const projectPages = {
  ...
  netdoctor: {
    ...
    screenshots: [
      { src: "/projects/netdoctor/start.png", caption: { en: "Welcome — choose language, region, and theme", fa: "خوش‌آمد — انتخاب زبان، منطقه و تم", ar: "الترحيب — اختر اللغة والمنطقة والسمة", de: "Willkommen — Sprache, Region und Theme wählen" } },
      { src: "/projects/netdoctor/dashboard.png", caption: { en: "Command center — live health, checks, and safe fixes", fa: "مرکز فرماندهی — سلامت زنده، بررسی‌ها و ترمیم امن", ar: "مركز القيادة — الصحة المباشرة والفحوصات والإصلاح الآمن", de: "Command Center — Live-Status, Prüfungen und sichere Reparaturen" } },
      { src: "/projects/netdoctor/start-iran.png", caption: { en: "Iran Edition — right-to-left Persian welcome", fa: "نسخه ایران — خوش‌آمد فارسی راست‌به‌چپ", ar: "إصدار إيران — ترحيب فارسي من اليمين إلى اليسار", de: "Iran Edition — persischer RTL-Willkommensbildschirm" } },
      { src: "/projects/netdoctor/dashboard-iran.png", caption: { en: "Iran Edition — Persian command center", fa: "نسخه ایران — مرکز فرماندهی فارسی", ar: "إصدار إيران — مركز القيادة الفارسي", de: "Iran Edition — persisches Command Center" } }
    ],
    steps: [
